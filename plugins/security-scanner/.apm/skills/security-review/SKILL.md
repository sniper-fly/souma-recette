...
description: "security-check が内部で使用する、ファイル群を受け取りマルウェア・悪意のあるコードパターンを検出するworkerスキル。単体で呼び出す必要はありません。"
allowed_tools: Read, Grep, Glob
disable-model-invocation: true
---

# マルウェアスキャン(security-check worker)

マルウェア検出の専門家として、指定されたファイル群に対して悪意のあるコードパターンを検出してください。
